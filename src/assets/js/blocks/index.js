(function initMainSlider() {
    if( $('div').is('.js-main-slider') ) {
        $('.js-main-slider').on('init', onSliderInit);
        $('.js-main-slider').on('afterChange', onSliderInit);
        $('.js-main-slider').slick({
            ...
            autoplay: true,
            autoplaySpeed: 4000,
            appendDots: '.dots-wrapper_main-header',
...
(function changeSpeedVideo() {
    if( $('div').is('.main-video') ) {
