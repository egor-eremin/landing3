        ...
        getBuild: function(lang, idBlock) {
            ...
            if (mainBlock) {
                ...
                if (this.defaultTitles[lang]) {
                    ...
                    innerHTMLcontent += '<button class="clc-buttonsCta__btn btn btn-2 btn-main btn_small" onclick="getCalculate.getData();"><span>' + this.defaultTitles[langBuild].submitBtn + '</span></button>';
                    innerHTMLcontent += '<button class="clc-buttonsCta__btn btn btn-3 btn_small btn-second" onclick="getCalculate.cleanAll(\'' + langBuild + '\');">' + this.defaultTitles[langBuild].resetBtn + '</button>';
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';
